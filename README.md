...
https://www.twilio.com/en-us/blog/voice-ai-assistant-openai-realtime-api
  ...
  <h2><li>You can start the program</li></h2>
  <p>Use command
  ...
  In this example we use ngrok.
  Download and install ngrok. Afterwards run the following command:
    <pre><code>ngrok http 5050</code></pre>
